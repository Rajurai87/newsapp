...
const Navbar = () => {
    return (
        <>
            <div>
                <nav className="navbar navbar-expand-lg bg-dark body-dark">
                    <div className="container-fluid">
                        <Link className="navbar-brand text-white" to="/"><h5>NEWS TODAY</h5> </Link>
                        ...
                        <div className="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
                                ...
                                <li className="nav-item">
                                    <Link className="nav-link text-white" aria-current="page" to="/sport">Sport</Link>
                                </li>
                                ...
                                <li className="nav-item">
                                    <Link className="nav-link text-white" aria-current="page" to="/health">Health</Link>
                                </li>
